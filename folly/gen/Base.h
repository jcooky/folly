...
template <class Value>
class SingleLValueReference;

template <class Value>
class SingleRValueReference;
...
template <
    ...
    class Just = typename std::conditional<
        ...
        detail::SingleLValueReference<typename std::remove_reference<Value>::type>,
        typename std::conditional<
            std::is_rvalue_reference<Value>::value,
            detail::SingleRValueReference<typename std::remove_reference<Value>::type>,
            detail::SingleCopy<Value>>::type>::type>
